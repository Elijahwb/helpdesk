							...
							<div class="card-body">
								<div class="email-left-box px-0 mb-3">
									...
									<div class="mail-list mt-4">
										<a href="/tickets" class="list-group-item"><i
												class="fa fa-inbox font-18 align-middle mr-2"></i> Unassigned <span
												class="badge badge-primary badge-sm float-right">{{count($opentickets)}}</span> </a>
										<a href="/opentickets" class="list-group-item active"><i
											class="fa fa-paper-plane font-18 align-middle mr-2"></i>Open </a>
									<!--		<a-->
									<!--	href="/opentickets" class="list-group-item"><i-->
									...
									<!--</a>-->
									<!--<a href="/closedtickets" class="list-group-item"><i-->
									<!--		class="mdi mdi-file-document-box font-18 align-middle mr-2"></i>Onhold</a>-->
											<a
		...
		<div class="modal-body">
		    <div class="compose-content">
				<form action="tickets" method="post" id="createticket">
					...
					<select class="form-control" id="ticketsource" name="source" required>
				...
				<div class="form-group">
					<label for="ticketsource">Ticket priority</label>
				...
				<div class="form-group">
					<label for="ticketsource">Assign to group (optional)</label>
