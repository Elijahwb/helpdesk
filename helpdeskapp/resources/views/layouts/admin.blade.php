...
<body>
                            ...
                            <li class="nav-item dropdown header-profile">
                                <a class="nav-link" href="javascript:;" role="button" data-toggle="dropdown">
									...
									<div class="header-info">
										<span style="text-transform: capitalize"> {{ Auth::user()->username }} <i class="fa fa-caret-down ml-3" aria-hidden="true"></i></span>
									</div>
                                </a>
                                <div class="dropdown-menu dropdown-menu-right">
									...
									<form class="dropdown-item ai-icon" action=" {{ route('logout') }} " method="post">
										@csrf
										<button type="submit" style="background: transparent;outline:none; border:none;color: #b7b7b7;"> <svg id="icon-logout" xmlns="http://www.w3.org/2000/svg" class="text-danger" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path><polyline points="16 17 21 12 16 7"></polyline><line x1="21" y1="12" x2="9" y2="12"></line></svg>
		...
		<div class="deznav">
			<div class="deznav-scroll">
				<ul class="metismenu" id="menu">
					<li><a class="has-arrow ai-icon mm-show" href="javascript:void()" aria-expanded="false">
						...
						<ul aria-expanded="false" class="mm-show">
							...
							<li><a class="" href="{{route('viewagents')}}">
							...
							@if(Auth::user()->userrole_id == 1)
								<li>
									<a class="" href="{{route('viewsupervisors')}}" >
							...
							<li><a href="supervisor analytics.html">Analytics</a></li>
                            <li><a href="customers.html">Settings</a></li>
						</ul>
					</li>
				</ul>
			</div>
    ...
    ***********************************-->
    <div class="footer">
        <div class="copyright">
            <p>Copyright © Designed &amp; Developed by <a href="http://projectcode.ug/" target="_blank">ProjectCode</a> 2021</p>
        </div>
    </div>
    <!--**********************************
        Footer end
